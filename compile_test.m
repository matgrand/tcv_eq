...
try
    mex('', ... % -v for verbose output to show all warnings
        'CXXFLAGS="\$CXXFLAGS -std=c++17 -fPIC -O2"', ... % Added -Wall and -Wextra for more warnings
...
% NOTE: do this before:
% export LD_LIBRARY_PATH=/home/mg/libtorch/lib:$LD_LIBRARY_PATH