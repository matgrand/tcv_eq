...
ONNX_NET_PATH="$(pwd)/data/best_old/net.onnx" # <- change accordingly
# ONNX_NET_PATH="$(pwd)/data/local/net.onnx" # <- change accordingly
...
# test in MATLAB 
echo "----- Matlab --------------------------------------------------------------------"
# matlab -nodisplay -nosplash -nodesktop -r "run('forward_test.m'); exit;" # <- correct version (but bugged on arch)
matlab -nosplash -nodesktop -r "run('forward_test.m'); exit;" # workaround 
echo "---------------------------------------------------------------------------------"
